...
Potree.Shaders["edl.fs"] = [
    ...
    "varying vec2 vUv;",
    "",
    "const float infinity = 1.0 / 0.0000001;",
    "",
...
Potree.OrbitControls = class OrbitControls extends THREE.EventDispatcher{
    ...
    constructor(viewer){
        ...
        let drag = (e) => {
            ...
            }else if(e.drag.mouse === Potree.MOUSE.MIDDLE){
                //here will go the zoom on middle mouse
                //this.panDelta.x += ndrag.x;
                //this.panDelta.y += ndrag.y;
                console.log(e.drag.lastDrag.y)
                let resolvedRadius = this.scene.view.radius + this.radiusDelta;
                this.radiusDelta +=  .016 * e.drag.lastDrag.y  * resolvedRadius * 0.1;
            }
        };
        ...
        let handleKeyDown = e => {
            console.log( e.keyCode, this.keys.UP, 'handleKeyDown' );
            ...
            switch ( e.keyCode ) {
                ...
                case this.keys.BACKWARD[0]:
                case this.keys.BACKWARD[1]:
                    //var resolvedRadius = this.scene.view.radius + this.radiusDelta;
                    //this.radiusDelta +=  .016  * resolvedRadius;
                    this.panDelta.y -= .005;
                    this.update(0.01);

                    break;

                case this.keys.FORWARD[0]:
                case this.keys.FORWARD[1]:
                    //var resolvedRadius = this.scene.view.radius + this.radiusDelta;
                    //this.radiusDelta -=  .016  * resolvedRadius;
                    this.panDelta.y += .005;
                    this.update(0.01);
...
function initClassificationList(){
    ...
    addClassificationItem(8, "powerline");
            ...
            if(measurement instanceof Potree.Profile){
                ...
                elWidthSlider.slider({
                    ...
                    slide: function(event, ui){
                        ...
                        console.log(event);
                        elWidthLabel.html(Potree.utils.addCommas(val.toFixed(3)));
